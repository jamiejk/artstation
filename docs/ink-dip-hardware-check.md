...
8. Upload a two-stroke scrap SVG with automatic dipping enabled and a short interval. The interval comes from the single Automatic ink dipping control in the Ink Well panel; saving updates the default and any paused auto-dip job. Check the reported dip count and longest-stroke warning before Start.
